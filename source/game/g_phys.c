...
static void SV_Physics_Toss( edict_t *ent )
{
	...
	if( ent->velocity[2] > 0 || ent->movetype == MOVETYPE_FLY )
		ent->groundentity = NULL;
	...
	// if onground and stopped, return without moving
	if( ent->groundentity && VectorLength( ent->velocity ) == 0.0f )
		return;
