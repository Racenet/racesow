...
qboolean ( *module_CheckBladeAutoAttack )( player_state_t *playerState );
...
#define	ARMOR_DEGRADATION 0.85 // how much armor is lost per damage point taken
...
#define EF_NOPORTALENTS				EF_CARRIER	// oh, this is so nasty...
...
int GS_ThinkPlayerWeapon( player_state_t *playerState, int buttons, int msecs );
