...
//#define my_reinterpret_cast(A) reinterpret_cast<A> //FIXME: MINGW-W64
...
#define extern double2ulonglong(A) ((ulonglong) (double) (A)) //FIXME: MINGW-W64
#endif
#endif
...
extern inline char *strtok_r(char *str, const char *delim, char **saveptr)
{
  return strtok(str,delim);
}
#endif //FIXME: MINGW-W64
