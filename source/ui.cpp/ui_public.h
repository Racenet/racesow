...
typedef struct
{
	...
	void ( *R_DrawStretchPoly )( const struct poly_s *poly );
	...
	void ( *R_FitModelPositionInViewport)( const struct model_s* mod, vec3_t angles, float fovx, float fovy, vec3_t outOrigin );
