...
//==================
static void TVM_RelayCommand_Pass( tvm_relay_t *relay, frame_t *frame, gcommand_t *gcmd )
{
	int i;
	int target;
	edict_t *ent;
...
//TVM_RelayCommand
//==================
void TVM_RelayCommand( tvm_relay_t *relay, frame_t *frame, gcommand_t *gcmd )
{
