...
void SNAP_SkipFrame( msg_t *msg, struct frame_s *header );
struct frame_s *SNAP_ParseFrame( msg_t *msg, struct frame_s *lastFrame, int *suppressCount, struct frame_s *backup, entity_state_t *baselines, int showNet );
