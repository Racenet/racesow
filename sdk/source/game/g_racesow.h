...
char *RS_StartPlayerSession( int );
...
extern qboolean RS_MysqlPlayerDisappear( char *name, int playtime, int player_id, int nick_id, int map_id, int is_authed, int is_threaded);
