...
namespace UIWsw
{
	...
	public:
		...
		static inline struct shader_s *R_RegisterLevelshot( const char *name, struct shader_s *defaultPic, qboolean *matchesDefault ) {
		...
		static inline void R_DrawStretchPoly( const poly_t *poly ) {
			UI_IMPORT.R_DrawStretchPoly( poly );
		}
